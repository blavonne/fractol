...
**
** Il height a des differences entre X11 et MacOS.
...
/*
**  origin for width & height is top left corner of the window
**  height down is positive
**  color is 0x00RRGGBB
*/
...
**   mouse_hook(int button, int width,int height, void *param);

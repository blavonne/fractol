...
void	tree(t_fractol *fractol)
{
	...
	draw_line(complex_to_screen((t_complex){.re = 0, .im = -1}, fractol->g.size, fractol->g.min,\
	(t_point){.x = 0, .y = 0}), complex_to_screen((t_complex){.re = 0,\
	.im = -0.1}, fractol->g.size, fractol->g.min, (t_point){.x = 0, .y = 0}), fractol);
